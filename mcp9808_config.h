...
typedef enum {
    MCP9808_SLAVE_ADDRESS_A2L_A1L_A0L = 0b0011000,
    MCP9808_SLAVE_ADDRESS_A2L_A1L_A0H = 0b0011001,
    MCP9808_SLAVE_ADDRESS_A2L_A1H_A0H = 0b0011011,
    MCP9808_SLAVE_ADDRESS_A2H_A1H_A0H = 0b0011111,
    MCP9808_SLAVE_ADDRESS_A2H_A1H_A0L = 0b0011110,
    MCP9808_SLAVE_ADDRESS_A2H_A1L_A0L = 0b0011100,
    MCP9808_SLAVE_ADDRESS_A2L_A1H_A0L = 0b0011010,
    MCP9808_SLAVE_ADDRESS_A2H_A1L_A0H = 0b0011101,
} mcp9808_slave_address_t;
