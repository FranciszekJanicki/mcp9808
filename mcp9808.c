...
mcp9808_err_t mcp9808_get_config_reg(mcp9808_t const* mcp9808, mcp9808_config_reg_t* reg)
{
    ...
    mcp9808_err_t err = mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_CONFIG, data, sizeof(data));
...
mcp9808_err_t mcp9808_set_config_reg(mcp9808_t const* mcp9808, mcp9808_config_reg_t const* reg)
{
    ...
    err |= mcp9808_bus_write_data(mcp9808, MCP9808_REG_ADDR_CONFIG, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_t_upper_reg(mcp9808_t const* mcp9808, mcp9808_t_upper_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_T_UPPER, data, sizeof(data));
...
mcp9808_err_t mcp9808_set_t_upper_reg(mcp9808_t const* mcp9808, mcp9808_t_upper_reg_t const* reg)
{
    ...
    err |= mcp9808_bus_write_data(mcp9808, MCP9808_REG_ADDR_T_UPPER, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_t_lower_reg(mcp9808_t const* mcp9808, mcp9808_t_lower_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_T_LOWER, data, sizeof(data));
...
mcp9808_err_t mcp9808_set_t_lower_reg(mcp9808_t const* mcp9808, mcp9808_t_lower_reg_t const* reg)
{
    ...
    err |= mcp9808_bus_write_data(mcp9808, MCP9808_REG_ADDR_T_LOWER, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_t_crit_reg(mcp9808_t const* mcp9808, mcp9808_t_crit_reg_t* reg)
{
    ...
    mcp9808_err_t err = mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_T_CRIT, data, sizeof(data));
...
mcp9808_err_t mcp9808_set_t_crit_reg(mcp9808_t const* mcp9808, mcp9808_t_crit_reg_t const* reg)
{
    ...
    err |= mcp9808_bus_write_data(mcp9808, MCP9808_REG_ADDR_T_CRIT, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_t_ambient_reg(mcp9808_t const* mcp9808, mcp9808_t_ambient_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_T_AMBIENT, data, sizeof(data));
                                              ...
                                              mcp9808_manufacturer_id_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_MANUFACTURER_ID, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_device_id_reg(mcp9808_t const* mcp9808, mcp9808_device_id_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_DEVICE_ID, data, sizeof(data));
...
mcp9808_err_t mcp9808_get_resolution_reg(mcp9808_t const* mcp9808, mcp9808_resolution_reg_t* reg)
{
    ...
    mcp9808_err_t err =
        mcp9808_bus_read_data(mcp9808, MCP9808_REG_ADDR_RESOLUTION, &data, sizeof(data));
                                         ...
                                         mcp9808_resolution_reg_t const* reg)
{
    ...
    err |= mcp9808_bus_write_data(mcp9808, MCP9808_REG_ADDR_RESOLUTION, &data, sizeof(data));
